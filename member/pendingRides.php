...
<section>
    <div class="wrapper">
        ...
        <div id="pendingRideResult"></div>
    <table id="pendingRideTable">
            <thead>
                <tr>
                    <th>Sr.No.</th>
                    <th>Ride Date</th>
            ...
            foreach ($data as $row) {
                ?>
                    <tr>
                        ...
                        <td>
                            <form action="pendingRides.php" method="post" class="cancleRide">
